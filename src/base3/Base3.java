...
public class Base3 {
    ...
    public static void main(String[] args) {
        int i;
        //=======================================================
        GB.exePath = System.getProperty("user.dir").replace('\\', '/');
        System.out.println("exePath = " + GB.exePath);
        //==========================================================
        String fileName = GB.exePath+"/"+GB.appName+".properties";
        String wstr="";
        ...
        wstr+="\nlog4j.appender.fileout.File="+GB.exePath+"/log/"+GB.appName+".log";
        ...
        log.info("GB.exePath: "+GB.exePath);
        log.info("GB.webRootPath: "+GB.webRootPath);
        //===============================================
        ...
        Base3 cla = new Base3();
        scla = cla;
        //KvWebSocketServer.testServer(GB.webSocketServerPort);
        //System.exit(0);
        ...
        if (cla.debug_f != 1) {
            ...
            if (GB.process_inx == 1) {
                ...
                GB.sipmd_ipmask_str = GB.set_ipmask_str;
                GB.sipmd_gateway_str = GB.set_gateway_str;
                ConsoleSlot cs1 = new ConsoleSlot();
                cs1.create();
            }
